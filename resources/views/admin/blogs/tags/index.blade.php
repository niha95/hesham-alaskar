...
@section('subheader')
    ...
    <div class="d-flex align-items-center flex-wrap mr-2">
        ...
        <a href="{{ route('dashboard.tags.create') }}" class="btn btn-primary btn-sm font-weight-bolder
    ...
    <div class="d-flex align-items-center">
        ...
        <span class="btn-clean btn-sm font-weight-bold font-size-base mr-1">@lang('general.tags')</span>
        <!--end::Actions-->
        ...
        <tbody>
            @foreach($tags as $key => $value)
                <tr>
                    ...
                    <td>
                        <form class="delete-form" action="{{ route('dashboard.tags.destroy',$value->id) }}" method="post">
                            <a href="{{route('dashboard.tags.show',$value->id)}}" class="btn btn-info btn-sm"> <i
                                    class="fa fa-eye fa-sm"></i>  </a>
                            <a href="{{route('dashboard.tags.edit',$value->id)}}" class="btn btn-primary btn-sm"> <i class="fa fa-edit fa-sm"></i>  </a>
                            @csrf
                            @method('delete')
