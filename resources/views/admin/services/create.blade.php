...
@section('subheader')
    ...
    <div class="d-flex align-items-center">
        <!--begin::Actions-->
        <a href="{{ route('dashboard.services.index') }}" class="btn btn-clean btn-sm font-weight-bold font-size-base mr-1">@lang('general.services')</a> <span> / </span>
                ...
                <div class="card-body">
                    @foreach (config('translatable.locales') as $locale)
                            ...
                            <div class="col form-group">
                                ...
                                <label>@lang('general.icone')</label>

                            <input type="text" name="icone" class="form-control @error("icone")
                                is-invalid @enderror"  >
                            @error("icone ")
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
