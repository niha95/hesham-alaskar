            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    @foreach (config('translatable.locales') as $locale)
                        <div class="col form-group">
                            ...
                            <input type="text" name="{{ $locale }}[sitename]" class="form-control @error("$locale.sitename")
                                is-invalid @enderror" value="{{ $misc->translate($locale)->sitename }}" readonly>
                        ...
                        <div class="col form-group">
                            ...
                            <textarea name="{{ $locale }}[about]" id="{{ $locale }}[about]" placeholder="@lang('general.' . $locale . '.about')"
                                 class="form-control @error("$locale.about" ) is-invalid @enderror" cols="30" rows="5" readonly>{{ $misc->translate($locale)->about }}</textarea>
                        ...
                        <div class="col form-group">
                            ...
                            <textarea name="{{ $locale }}[site_word]" id="{{ $locale }}[site_word]" placeholder="@lang('general.' . $locale . '.site_word')"
                                 class="form-control @error("$locale.site_word" ) is-invalid @enderror" cols="30" rows="5" readonly>{{ $misc->translate($locale)->site_word }}</textarea>
                        ...
                        <div class="col form-group">
                            ...
                            class="form-control @error("$locale.vision" ) is-invalid @enderror" cols="30" rows="5" readonly>{{ $misc->translate($locale)->vision }}</textarea>
                        ...
                        iv class="col form-group">
                            ...
                            <input type="text" name="{{ $locale }}[appointment_date]" class="form-control @error("$locale.appointment_date")
                                is-invalid @enderror" value="{{ $misc->translate($locale)->appointment_date }}" readonly>
                    ...
                    <input type="text" name="address" class="form-control @error("address")
                        is-invalid @enderror" value="{{ $misc->address }}" readonly>
                    @error("address")
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col form-group">
                    ...
                    <input type="text" name="google_map" class="form-control @error("google_map")
                        is-invalid @enderror" value="{{ $misc->google_map }}" readonly>
                    @error("google_map")
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col form-group">
                    ...
                    <input type="text" name="links" class="form-control @error("links")
                        is-invalid @enderror"  value="{{ $misc->links }}" readonly>
                    @error("links")
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col form-group">
                    ...
                    <input type="text" name="video" class="form-control @error("video")
                        is-invalid @enderror"  value="{{ $misc->video }}" readonly>
                    @error("video   ")
                    <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <input type="text" name="phone" class="form-control @error("phone")
                    is-invalid @enderror"  value="{{ $misc->phone }}" readonly>
                @error("phone")
                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
