            ...
            <form action="{{ route('dashboard.users.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control @error('name') is-invalid @enderror"  placeholder="@lang('general.name')" value="{{$user->name}}" required/>
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror"  placeholder="@lang('general.email')" value="{{$user->email}}" required/>
                        @error('email')
                        <div class="invalid-feedback">
                            <strong>{{ $message }}</strong>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('type') is-invalid @enderror" id="exampleSelect1" name="type" required>
                            ...
                            <option value="user" @if($user->type == 'user') selected @endif>@lang('general.user')</option>
                            <option value="admin" @if($user->type == 'admin') selected @endif>@lang('general.admin')</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <div class="image-input image-input-outline" id="kt_image_1">
                            @if(isset($user->image))
                                <div class="image-input-wrapper" style="background-image: url({{$user->image->path}})"></div>
                            @else
