            ...
            <div class="col-xs-12">
                ...
                <nav class="site-nav">
                    <ul>
                        ...
                        <li><a href="#">@lang('nav.home') </a> <!-- Desktop sub menu indicator icon -->
                                  <!-- Mobile view sub menu indicator icon -->

                            <!-- Sub menu level 1 -->

                        <li class="active"><a href="#about">@lang('nav.about')</a></li>
                        <li><a href="#services">@lang('nav.service')</a></li>

                        <li><a href="#testimonial">@lang('nav.clients')</a></li>
                        <li><a href="#portfolio">@lang('nav.blog')</a></li>
                        {{-- <li><a href="#team">Team</a></li> --}}
                        <li><a href="#call-to-action">@lang('nav.contact')</a></li>
                        <li>
                        <div class="btn-group">
