        ...
        <div class="card card-custom">
            ...
            <form action="{{ route('dashboard.customers.update',$customer->id) }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    @foreach (config('translatable.locales') as $locale)
                        <div class="col form-group">
                            ...
                            <input type="text" name="{{ $locale }}[name]" class="form-control @error("$locale.name")
                                is-invalid @enderror" value="{{ $customer->translate($locale)->name }}">
                            @error("$locale.name")
                        ...
                        <div class="col form-group">
                            ...
                            <input type="text" name="{{ $locale }}[description]" class="form-control @error("$locale.description")
                                is-invalid @enderror" value="{{ $customer->translate($locale)->description }}">
                    ...
                    <label><input type="checkbox" name="top" value="{{ $customer->top }}"> @lang('general.top')</label>
