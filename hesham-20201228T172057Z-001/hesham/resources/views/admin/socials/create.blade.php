...
@section('content')
    <div class="col-12">
        <div class="card card-custom">
            ...
            <!--begin::Form-->
            <form action="{{ route('dashboard.socials.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label>@lang('general.fb') <span class="text-danger">*</span></label>
                        <input name="fb" type="text" class="form-control @error('fb') is-invalid @enderror"  placeholder="@lang('general.fb')" />
                        @error('fb')
                    ...
                    <div class="form-group">
                        ...
                        <input name="twitter" type="text" class="form-control @error('twitter') is-invalid @enderror"  placeholder="@lang('general.twitter')" />
                        @error('twitter')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="instagram" type="text" class="form-control @error('instagram') is-invalid @enderror"  placeholder="@lang('general.instagram')" />
                        @error('twitter')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="mail" type="email" class="form-control @error('mail') is-invalid @enderror"  placeholder="@lang('general.mail')" />
                        @error('mail')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
