...
@section('subheader')
    ...
    <div class="d-flex align-items-center">
        <!--begin::Actions-->
        <a href="{{ route('dashboard.blogCategories.index') }}" class="btn btn-clean btn-sm font-weight-bold font-size-base mr-1">@lang('general.blogCategories')</a> <span> / </span>
...
@section('content')
    <div class="col-12">
        <div class="card card-custom">
            ...
            <!--begin::Form-->
            <form action="{{ route('dashboard.blogCategories.update',$category->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="card-body">
                    {{--  input name  --}}
